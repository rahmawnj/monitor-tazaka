...
<div class="wrap">
    <div class="top">
        ...
        <div class="actions"><a class="btn" href="{{ route('monitor') }}" target="_blank">Buka Monitor</a><form method="POST" action="{{ route('logout') }}">@csrf<button class="btn">Logout</button></form></div>
    </div>
