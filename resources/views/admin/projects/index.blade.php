            ...
            @forelse($projects as $project)
                <div class="project" draggable="true" data-id="{{ $project->id }}">
                    ...
                    <div class="project-actions">
                        <a class="btn action-icon" href="{{ route('admin.projects.show',$project) }}" title="Detail" aria-label="Detail">
                        ...
                        <a class="btn primary action-icon" href="{{ route('admin.projects.edit',$project) }}" title="Edit" aria-label="Edit">
                        ...
                        <form method="POST" action="{{ route('admin.projects.destroy',$project) }}" class="delete-form">
                            @csrf @method('DELETE')
                            <button class="btn danger action-icon" type="submit" title="Hapus" aria-label="Hapus">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18"/><path d="M8 6V4h8v2"/><path d="M19 6l-1 15H6L5 6"/><path d="M10 11v6M14 11v6"/></svg>
                            </button>
                        </form>
                    </div>
                </div>
