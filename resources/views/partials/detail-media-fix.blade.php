<style>
    ...
    .detail-modal { width:min(1200px, calc(100vw - 32px)) !important; max-width:1200px !important; max-height:94vh !important; padding:32px !important; }
    .detail-media-grid { display:grid; grid-template-columns:minmax(0,1.15fr) minmax(0,.85fr); gap:16px; margin-top:24px; }
    ...
    .detail-location-map { min-height:300px; }
    #detailProjectMap { width:100%; height:300px; }
    ...
    .detail-map-note { height:300px; display:flex; align-items:center; justify-content:center; color:#64748b; font-size:12px; }
    @media(max-width:700px) { .detail-modal { width:calc(100vw - 20px) !important; padding:22px !important; } .detail-media-grid { grid-template-columns:1fr; } }
</style>
<script>
(() => {
    let detailMap = null;
