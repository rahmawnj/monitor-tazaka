...
<head>
    ...
    <style>
        *{box-sizing:border-box}body{margin:0;background:#070b14;color:#f8fafc;font-family:Inter,ui-sans-serif,system-ui,sans-serif}.wrap{max-width:1600px;margin:auto;padding:30px}.header{margin-bottom:24px}.eyebrow{font-size:11px;letter-spacing:.2em;color:#38bdf8;font-weight:800;text-transform:uppercase}.title{font-size:34px;font-weight:850;margin:5px 0}.muted{color:#94a3b8}.kpis{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-bottom:18px}.kpi,.card{background:#0d1320;border:1px solid #1e293b;border-radius:18px}.kpi{padding:20px}.kpi-label{font-size:12px;color:#94a3b8}.kpi-value{font-size:32px;font-weight:850;margin-top:8px}.layout-main{display:grid;grid-template-columns:minmax(0,1fr) 360px;gap:18px;align-items:stretch}.card{padding:20px}.card h2{font-size:16px;margin:0 0 18px}.project-card{min-width:0}.projects{display:grid;grid-template-columns:1fr 1fr;gap:12px}.project{padding:15px;border:1px solid #1e293b;border-radius:14px;background:#0a101b}.phead{display:flex;justify-content:space-between;gap:10px}.pname{font-weight:800}.client{font-size:12px;color:#94a3b8;margin-top:3px}.badge{font-size:10px;padding:4px 8px;border-radius:99px;background:#172554;color:#93c5fd;height:max-content}.progress{height:7px;background:#1e293b;border-radius:99px;margin-top:13px;overflow:hidden}.bar{height:100%;background:#38bdf8;border-radius:99px;transition:width .4s}.foot{display:flex;justify-content:space-between;font-size:11px;color:#64748b;margin-top:7px}.map-card{min-width:0}.map-wrap{height:100%;min-height:330px;border-radius:14px;overflow:hidden;border:1px solid #1e293b}.map{width:100%;height:100%;background:#0a101b}.leaflet-container{font-family:Inter,ui-sans-serif,system-ui,sans-serif;background:#0b1220}.leaflet-popup-content-wrapper,.leaflet-popup-tip{background:#0d1320;color:#f8fafc}.leaflet-popup-content{font-size:12px;line-height:1.5}.leaflet-control-zoom a{background:#0d1320;color:#f8fafc;border-color:#334155}.charts{display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-top:18px}.chart-wrap{height:280px}.chart-col{min-width:0}@media(max-width:1000px){.kpis{grid-template-columns:1fr 1fr}.layout-main{grid-template-columns:1fr}.map-wrap{height:360px}.charts{grid-template-columns:1fr}.projects{grid-template-columns:1fr}}@media(max-width:600px){.wrap{padding:16px}.title{font-size:25px}}
    </style>
</head>
<body>
<div class="wrap">
